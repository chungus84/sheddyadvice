class Listpost < ApplicationRecord
  ...
  validates_uniqueness_of :post_id, :scope => :list_id, :message => "Post is already in List"
  validates_uniqueness_of :list_id, :scope => :post_id, :message => "Post is already in List"
end
