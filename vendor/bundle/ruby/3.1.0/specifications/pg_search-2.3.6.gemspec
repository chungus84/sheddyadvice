...
Gem::Specification.new do |s|
  ...
  if s.respond_to? :add_runtime_dependency then
    ...
    s.add_development_dependency(%q<undercover>.freeze, [">= 0"])
    s.add_development_dependency(%q<warning>.freeze, [">= 0"])
    s.add_development_dependency(%q<with_model>.freeze, [">= 0"])
  else
    ...
    s.add_dependency(%q<undercover>.freeze, [">= 0"])
    s.add_dependency(%q<warning>.freeze, [">= 0"])
    s.add_dependency(%q<with_model>.freeze, [">= 0"])
  end
end
